...
# 
# In this activity, you will continue your work as a junior data analyst researching air quality data collected by the U.S. Environmental Protection Agency (EPA). You will now focus on air quality index (AQI), a metric used to measure and report air quality. AQI is a number that runs from 0 to 500. The higher the AQI value, the greater the level of air pollution and the greater the health concern. For example, an AQI value of 50 or below represents good air quality, while an AQI value over 300 represents hazardous air quality. Refer to this guide from [AirNow.gov](https://www.airnow.gov/aqi/aqi-basics/) for more information.
# 
