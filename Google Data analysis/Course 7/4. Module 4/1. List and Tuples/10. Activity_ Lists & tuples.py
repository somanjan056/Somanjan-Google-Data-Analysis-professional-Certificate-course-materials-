...
# 
# This activity is based on the following scenario: You are a junior data analyst working for an environmental research team that focuses on air quality. 
# 
# Your team has received data collected by the U.S. Environmental Protection Agency (EPA). Your goal is to store and organize this data, so that it can be accessed and updated easily.
# 
...
# 
# As you continue your work with the EPA data, you want to create an ordered data structure containing pairs of values, which can be iterated over to gain insights from the data.
